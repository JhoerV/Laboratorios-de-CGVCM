...
img_path = Path("redimensionadas_lab07/imagen_combinada_rgb.png")
...
negative_path = Path("redimensionadas_lab07/imagen_negativa.png")
...
grayscale_path = Path("redimensionadas_lab07/imagen_gris.png")
